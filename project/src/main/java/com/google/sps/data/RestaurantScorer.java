...
public final class RestaurantScorer {
  ...
  public static double score(Restaurant restaurant, JSONObject preferences) throws JSONException {
    ...
    if (distanceInMeters(currLocation, restaurant.getLatLngCoords())
        <= preferences.getJSONObject("radius").getInt("pref")) {
      score += radiusWeight;
    }
  ...
  public static double distanceInMeters(
    ...
    double distInMeters = EARTH_RADIUS * angleInRadians;
    return distInMeters;
  }
}